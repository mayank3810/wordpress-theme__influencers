        ...
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-12">
                <div class="main-banner-content">
                    ...
                    <form><input type="text" class="input-newsletter" placeholder="Enter your email address" /><button type="submit">Join with me now</button></form>
                </div>
            </div>
            <div class="col-lg-7 col-md-12">
                <div class="main-banner-image">
                    <img src="<?php echo get_theme_file_uri('images\banner-img-default.png')?>" class="main-image" alt="image"/>
                    <div class="banner-shape">
                        <img src="<?php echo get_theme_file_uri('images/line-bg1.png')?>" alt="image" />
                        <img src="<?php echo get_theme_file_uri('images/line-bg2.png')?>" alt="image" />
                    </div>
    </div>
</div>
...
<section id="about" class="about-area pt-70">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-5 col-md-12">
                <div class="about-image"><img src="images/instagram/insta-about1.png" class="main-image" alt="image" />
                    <div class="shape"><img src="images/instagram/insta-about-shape1.png" alt="image" /><img src="images/instagram/insta-about-shape2.png" alt="image" /></div>
                </div>
            </div>
            <div class="col-lg-7 col-md-12">
...
<section id="socialStatistics" class="social-statistics-area pt-100">
    ...
    <div class="shape1"><img src="images/instagram/insta-shape1.png" alt="image" /></div>
</section>
                ...
                <div class="audience-content"><span class="sub-title"><a href="#">@Alikamaya</a></span>
                    ...
                    <div class="audience-content-inner instagram-collaborations-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-collaborations-box"><?php echo get_theme_file_uri('images/collaborations-img2.jpg')?>" alt="image" />
                                    <h3>LUXE + COTTON</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner1.png" alt="image" /></a></div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner2.png" alt="image" /></a></div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner3.png" alt="image" /></a></div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner4.png" alt="image" /></a></div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner5.png" alt="image" /></a></div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner6.png" alt="image" /></a></div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner7.png" alt="image" /></a></div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-4 col-6">
                <div class="single-partners-box"><a target="_blank" href="#"><img src="images/instagram/partner/insta-partner8.png" alt="image" /></a></div>
            </div>
        </div>
    </div>
</section>
