...
if ( ! class_exists('WPPB_Options')){
	...
	class WPPB_Options{
		...
		public function add_admin_menu() {
			add_menu_page(
				esc_html__( 'Distinct Cloud', 'wp-pagebuilder' ),
				esc_html__( 'Distinct Cloud', 'wp-pagebuilder' ),
				'manage_options',
				'wppb-settings',
		...
		public static function create_admin_page() { ?>
            <div class="wrap">
                <h1><?php esc_html_e( 'Distinct Cloud Options', 'wp-pagebuilder' ); ?></h1>
                    ...
                    <table class="form-table wpex-custom-admin-login-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description"> <?php _e('Select post types that can be edited with Distinct Cloud.', 'wp-pagebuilder'); ?></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description"> <?php _e('Exclude the user roles that you want to prevent from editing this site with Distinct Cloud.', 'wp-pagebuilder'); ?></p>
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
									...
									<p class="description"> <?php _e('Clean Distinct Cloud cache & synchronize built-in layouts & blocks with server.', 'wp-pagebuilder'); ?></p>
                                </label>
                            </td>
                        </tr>
