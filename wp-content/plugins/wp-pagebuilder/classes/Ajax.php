...
if ( ! class_exists('WPPB_Ajax')){
	...
	class WPPB_Ajax{
		...
		public function __construct() {
			...
			//Get Template from Distinct Cloud Server
		...
		public function  wppb_page_save(){
			...
			$success_array = array( 'msg' => __('Distinct Cloud content has been updated.', 'wp-pagebuilder') );
			$error_array = array();
		...
		/**
		 * @since 1.0.0
		 * Delete css file generated by Distinct Cloud
		 */
