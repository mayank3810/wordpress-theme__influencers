		...
		public function print_edit_with_wp_pagebuilder_button(){
			...
			<script id="wppb-edit-with-btn-in-gutenberg-toolbar" type="text/html">
				<div class="wppb-editor-warper">
					<a href="<?php echo wppb_helper()->get_editor_url($post->ID); ?>" class="components-button  is-button is-primary is-large edit-with-wppb-builder" style="display: <?php echo $currentEditor !== 'wppb_builder_activated'? 'block':'none'; ?>;"><?php _e('Edit With Distinct Cloud','wp-pagebuilder');?></a>
